      ...
      it("expect - make an assertion about a specified subject", function() {
        ...
        cy
          ...
          .should(function($p) {
            ...
            expect(texts).to.deep.eq(["Some text from first p", "More text from second p", "And even more text from third p"]);
          });
      });
    });
  });
  ...
  context("Utilities", function() {
    ...
    it("Cypress.Blob.method() - blob utilities and base64 string conversion", function() {
      cy.get(".utility-blob").then(function($div) {
        ...
        return Cypress.Blob.imgSrcToDataURL("https://example.cypress.io/assets/img/javascript-logo.png", undefined, "anonymous").then(function(
          dataUrl
        ) {
